...
var Menu = Widget.extend({
    ...
    events: {
        ...
        'click .dashboard-data': '_onAppNameClicked_ex',
    },
    ...
    _onAppNameClicked: function (ev) {
        //console.log("=-=-=-=--=--=--",this.current_primary_menu)
     ...
     * @param {MouseEvent} ev
     */
     _onAppNameClicked_ex: function (ev) {
        //console.log("----------==========-------my",ev)
        var self=this
        // this._rpc({
        ...
        //         console.log("=-=-=-run")
        //     });
        var main_menu = $(".o_menu_brand")
        //console.log("----------==========-------my",ev,main_menu)
        this._rpc({
            model: 'ir.actions.actions',
            method: 'find_view_id',
            args: [main_menu, {'main_menu': main_menu[0].innerHTML}],
        }).then(function (data) {
            //console.log("-----------------------",data['record_id'])
            var actionID = parseInt(self.menu_id_to_action_id(data));
            //console.log("=-=--=-=-=-=-=-=-=-=-=-",actionID)
            self._trigger_menu_clicked(data['menu'], data['record_id']);
...
return Menu;
    ...
    function random_bg_color() {
     ...
     console.log("background",bgColor);
        ...
        document.getElementsByClassName("dashboard_bg_color").style.backgroundColor = bgColor;
        random_bg_color();
    }
...
function getRandomColor() {
    ...
    var tags = document.getElementsByClassName("oe_action").style
    // document.getElementsByClassName("oe_action").style.backgroundColor = color;
    // $(".o_dashboard .oe_dashboard .oe_action").css("backgroundColor", "color");
    //console.log("hghghghgjhgjhgjhgjghg1111111111111111111111jhgjh",color, tags);
};
