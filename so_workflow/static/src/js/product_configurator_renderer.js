...
var ProductConfiguratorFormRenderer = FormRenderer.extend(ProductConfiguratorMixin ,{
    ...
    start: function () {
        this._super.apply(this, arguments);
        $(this.$el[0].childNodes[0].children[0].childNodes[0].children[1].cells[0]).append($("<p/><p> &nbsp; </p> <label class='o_form_label'>Attributes</label>"));
        $(this.$el[0].childNodes[0].children[0].childNodes[0].children[1].cells[1]).append($('<div>', {class: 'configurator_container'}));
    },
