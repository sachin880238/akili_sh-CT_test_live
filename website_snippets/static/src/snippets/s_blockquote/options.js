odoo.define('website_snippets.s_blockquote_options', function (require) {
'use strict';
...
options.registry.Blockquote = options.Class.extend({
    ...
    display: function (previewMode, widgetValue, params) {
        ...
        if (widgetValue === 'cover') {
            $blockquote.css({"background-image": "url('/website_snippets/static/src/img/s_blockquote_cover.jpg')"});
