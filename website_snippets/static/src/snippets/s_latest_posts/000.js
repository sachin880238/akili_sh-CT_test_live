odoo.define('website_snippets.s_latest_posts_frontend', function (require) {
'use strict';
...
publicWidget.registry.js_get_posts = publicWidget.Widget.extend({
    ...
    start: function () {
        ...
        if (data.template && data.template.endsWith('.s_latest_posts_big_orizontal_template')) {
            data.template = 'website_snippets.s_latest_posts_horizontal_template';
        }
        const template = data.template || 'website_snippets.s_latest_posts_list_template';
