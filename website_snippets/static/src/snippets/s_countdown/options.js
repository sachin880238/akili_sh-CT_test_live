odoo.define('website_snippets.s_countdown_options', function (require) {
'use strict';

const core = require('web.core');
const options = require('web_editor.snippets.options');
const CountdownWidget = require('website_snippets.s_countdown');
    ...
    endAction: function (previewMode, widgetValue, params) {
        ...
        if (widgetValue === 'message') {
            if (!this.$target.find('.s_countdown_end_message').length) {
                const message = this.endMessage || qweb.render('website_snippets.s_countdown.end_message');
