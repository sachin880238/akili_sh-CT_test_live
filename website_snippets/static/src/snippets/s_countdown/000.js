odoo.define('website_snippets.s_countdown', function (require) {
'use strict';
...
const CountdownWidget = publicWidget.Widget.extend({
    ...
    xmlDependencies: ['/website_snippets/static/src/snippets/s_countdown/000.xml'],
        ...
        if (this.endAction === 'redirect') {
            ...
            if (this.hereBeforeTimerEnds) {
                ...
                if (!this.$('.s_countdown_end_redirect_message').length) {
                    ...
                    $container.append(
                        $(qweb.render('website_snippets.s_countdown.end_redirect_message', {
